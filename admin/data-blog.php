                ...
                <thead>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="align-middle text-center"><a style = "color: inherit; text-decoration: none;" href="read-blog?id=<?php echo $row['id_blog']; ?>" class="title"><?php echo $row['judul']; ?></a></td>
                        <td class="align-middle text-center"><?= substr($row["isi_blog"], 0, 50); ?></td>
                        <td class="align-middle text-center"><img src="../Authentication/image/<?php echo $row['gambar']; ?>" class="img-thumbnail img-fluid w-50"> </td>
