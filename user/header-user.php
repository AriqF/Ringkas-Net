        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if($currentPage =='user_home'){echo 'active';}?>" href="dashboard">Beranda</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item <?php if($currentPage =='user_write_blog'){echo 'active';}?>" href="write-blog"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Menulis</a>
                            <a class="dropdown-item <?php if($currentPage =='user_blog'){echo 'active';}?>" href="my-blog"> <i class="fas fa-file-alt"></i>&nbsp;Blog Saya</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if($currentPage =='user_profile'){echo 'active';}?>" href="profile">Profil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if($currentPage =='user_rate'){echo 'active';}?>" href="feedback">Feedback</a>
                    </li>
                    <li class="nav-item">
        ...
        <script>
            ...
            function logOut(){
                ...
                if (result.isConfirmed) {
                    window.location = "../register/auth?logout=1";
                }
                })
            }
        </script>