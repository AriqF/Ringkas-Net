        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12 text-center">
                    ...
                    <a href="write-blog" class="btn btn-xl" role="button" id="btn_write">Mulai Menulis</a>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4 anim">
                        ...
                        <div class="p-2 bd-highlight">
                                <h5 class="font-weight-bold"><a href="read-blog?id=<?php echo $rowpopular['id_blog']; ?>" class="title"><?php echo $rowpopular['judul']; ?></a></h5>
                            </div>
                        <div class="p-2 bd-highlight">
    ...
    <section class="page-section" id="boxBlog" style="padding-top: 40px; padding-bottom:20px">
                ...
                <?php
                    ...
                    ?>
                        <div class="col-xl-3 col-lg-4 col-md-6 mb-4 anim">
                            ...
                            <div class="p-2 bd-highlight">
                                <h5 class="font-weight-bold"><a href="read-blog?id=<?php echo $row['id_blog']; ?>" class="title"><?php echo $row['judul']; ?></a></h5>
                            </div>
                            <div class="p-2 bd-highlight">
        ...
        <nav class="nav justify-content-center">
          <ul class="pagination">
            ...
            <li>  
              <a href="dashboard?laman=<?php echo $laman_sekarang - 1 ?>">
