...
<head>
    ...
    <header class="blog-header text-center">
        ...
        <p class="lead" style="font-size: 16px;"><span style="color: #2ED329; font-size: 17px;">#penulis</span> &#8231; 22/01/87</p>
        <hr class="divider">
    </header>
    <div class="page-section blog-page">

        <div class="container">
            <img src="../src/img/index-bg.jpg" class="img-fluid rounded" style="border: none;">
