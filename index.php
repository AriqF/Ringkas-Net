<html>
    <head>
        <title>AdoptMe | Home</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

        <!-- icon -->
        <link rel="icon" type="image/png" href="src/img/adoptMe.png">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        ...
        <!--Services-->
        <section class="page-section" id="services" style="padding-top: 90px; padding-bottom:40px">
            <div class="container">
                <h2 class="text-center mt-0"><i class="fas fa-chart-line"></i> Sedang Populer</h2>
                <hr class="divider my-4" />  
                <div class="d-flex flex-column bd-highlight mb-3"> <!--coloumn-->
                    <!--row 1-->
                        ...
                        <div class="d-flex flex-row bd-highlight mb-3">
                            <div class="p-2 bd-highlight">
                                <div class="d-flex flex-column bd-highlight mb-3">
                                    ...
                                    <div class="p-2 bd-highlight">
                                        <h5 class="font-weight-bold">Kode Yang Baik Ialah Kode Yang Mudah Dibaca Oleh Orang Lain</h5>
                                    </div>
                                    <div class="p-2 bd-highlight">
                            ...
                            <div class="p-2 bd-highlight">
                                <div class="d-flex flex-column bd-highlight mb-3">
                                    <div class="p-2 bd-highlight"><i class="fas fa-user-tie"></i> Abah Tua</div>
                                    <div class="p-2 bd-highlight">
                                        <h5 class="font-weight-bold">Bolehkah Menunda?</h5>
                                    </div>
                                    <div class="p-2 bd-highlight">
                                        <p class="desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                                    </div>
                            ...
                            <div class="p-2 bd-highlight">
                                <div class="d-flex flex-column bd-highlight mb-3">
                                    <div class="p-2 bd-highlight"><i class="fas fa-user-tie"></i> Ariq Fachry</div>
                                    <div class="p-2 bd-highlight">
                                        <h5 class="font-weight-bold">Bitcoin Punya Nilai Intrinsik?</h5>
                                    </div>
                                    <div class="p-2 bd-highlight">
                                        <p class="desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                                    </div>
                    ...
                    <div class="p-2 bd-highlight">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="p-2 bd-highlight">
                                <div class="d-flex flex-column bd-highlight mb-3">
                                    <div class="p-2 bd-highlight"><i class="fas fa-user-tie"></i> Uang Farmer</div>
                                    <div class="p-2 bd-highlight">
                                        <h5 class="font-weight-bold">Bitcoin Punya Nilai Intrinsik?</h5>
                                    </div>
                                    <div class="p-2 bd-highlight">
        ...
        <section class="about" id="about">
            <div class="container h-100" id="container_about" >
                <div class="row h-100 align-items-center">
                    <div class="col-12 text-center">
