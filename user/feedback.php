    ...
    <section class="page-section" id="boxForm">
        <div class="container-fluid">
            <div class="container">
                ...
                <form method="POST" class="rating" action="function-user-feedback" id="rateForm" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" name="username" value="<?php echo $_SESSION['username']; ?> " hidden>
                    <div class="w-100"></div>
                    ...
                    <div class="custom-control custom-checkbox" style="margin-top: 12px;">
                        <abbr title="Jika anda mencentang opsi ini, sistem tidak akan mengirim informasi identitas anda">
